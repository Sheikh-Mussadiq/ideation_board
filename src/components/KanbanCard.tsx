...
interface KanbanCardProps {
  card: IdeaCard;
  isDragging?: boolean;
  onUpdate: (cardId: string, updates: Partial<IdeaCard>) => void;
...
export default function KanbanCard({ 
  ...
  const borderColor = card.labels[0]?.color ? LABEL_COLORS[card.labels[0].color as keyof typeof LABEL_COLORS] : undefined;
  ...
  return (
    ...
    >
      <div className="space-y-3">
        ...
        {card.labels.length > 0 && ( console.log(card),
