...
//         name: file.name,
//         size: file.size,
//         storagePath: filePath, // Store the storage path for later deletion
//         createdAt: new Date().toISOString(),
//       });
...
//             Add Link
//           </button>
//           <label className={`flex items-center px-3 py-1.5 text-sm text-design-primaryPurple bg-design-lightPurpleButtonFill rounded-lg hover:bg-button-primary-cta hover:text-white transition-all duration-300 transform hover:scale-105 cursor-pointer ${isUploading ? 'opacity-50 pointer-events-none' : ''}`}>
//             {isUploading ? (
//               <>
