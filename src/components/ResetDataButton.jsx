...
export default function ResetDataButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 right-4 btn-primary disabled:opacity-50 hover:scale-105 transition-transform shadow-lg hover:shadow-xl dark:disabled:bg-button-disabled-fill dark:disabled:text-button-disabled-text"
    >
      <RefreshCw
