...
export default function IdeationPage() {
  ...
  const handleCardChange = (updatedCard: IdeaCard) => {
  ...
  const handleColumnChange = (updatedColumn: Column) => {
    setBoards(prev => prev.map(board => ({
      ...board,
      columns: board.columns.map(column => 
  ...
  const handleUpdateCard = async (cardId: string, updates: Partial<IdeaCard>) => {
    try {
